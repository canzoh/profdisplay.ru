(() => {
  ...
  document.querySelector(".catalog__swiper") &&
    new se(".catalog__swiper", {
      modules: [ne, le],
      slidesPerView: 6,
      slidesPerGroup: 3,
      loop: !0,
      ...
      breakpoints: {
        ...
        992: { slidesPerView: 4, spaceBetween: 20, slidesPerGroup: 2 },
        1268: { slidesPerView: 6, spaceBetween: 26 },
      },
      on: {
        init() {
    ...
    document.querySelector(".areas-of-use__swiper") &&
      new se(".areas-of-use__swiper", {
        modules: [ne, le],
        slidesPerView: 1,
        slidesPerGroup: 1,
        loop: !0,
    ...
    document.querySelector(".news__swiper") &&
      new se(".news__swiper", {
        modules: [re],
        loop: !0,
        loopFillGroupWithBlank: !0,
        ...
        preloadImages: !1,
        lazy: !0,
        pagination: { el: ".news__pagination", type: "bullets", clickable: !0 },
        breakpoints: {
          320: { slidesPerView: 1, slidesPerGroup: 1, autoHeight: !0 },
          768: { slidesPerView: 2, spaceBetween: 20, slidesPerGroup: 1 },
          992: { slidesPerView: 3, spaceBetween: 34, slidesPerGroup: 1 },
          1268: { slidesPerView: 4, spaceBetween: 34 },
        },
        on: {
          init() {
            this.el.addEventListener("mouseenter", () => {
    ...
    document.querySelector(".vendors__swiper") &&
      new se(".vendors__swiper", {
        modules: [le, re],
        slidesPerView: 5,
        slidesPerGroup: 1,
        spaceBetween: 30,
        ...
        new se(".promo__swiper", {
          ...
          pagination: {
            ...
            renderBullet: function (e, t) {
              return '<span class="' + t + '"><i></i><b></b></span>';
            },
          },
          on: {
            init() {
  ...
  const de = document.querySelector(".header__menu"),
    ce = document.querySelector(".header__logo"),
    pe = document.querySelector(".header__order-a-call"),
    ue = document.querySelector(".header__btn"),
    he = document.querySelector(".wrappe-search");
  document.querySelector(".fa-search").addEventListener("click", function () {
    document.querySelector(".search2").classList.toggle("active-s"),
      document.querySelector(".input").classList.toggle("active-s"),
      de.classList.toggle("display-none"),
      ce.classList.toggle("display-none"),
      pe.classList.toggle("display-none"),
      ue.classList.toggle("display-none"),
      he.classList.toggle("wrappe-search--activ"),
      document.querySelector(".active-s")
        ? document.documentElement.classList.add("lock")
        : document.documentElement.classList.remove("lock");
  }),
    document
      .querySelector(".footer__menu-help")
    ...
    document
      .querySelector(".footer__menu-katalog")
      .addEventListener("click", function () {
        document
          .querySelector(".footer__menu-katalog")
          .classList.toggle("menu-open");
    ...
    document
      .querySelector(".footer__menu-services")
      .addEventListener("click", function () {
        document
          .querySelector(".footer__menu-services")
          .classList.toggle("menu-open");
    ...
    (function () {
      ...
      e &&
        e.addEventListener("click", function (e) {
          let t = document.querySelector(".menu-open");
          document
            .querySelector(".nav__item")
            .addEventListener("click", function () {
              document
                .querySelector(".icon-menu")
                .classList.add("icon-menu--title");
            }),
            null == t
              ? (i(), document.documentElement.classList.toggle("menu-open"))
              : t && document.querySelector(".icon-menu--title")
              ? (i(),
                document
                  .querySelector(".icon-menu")
                  .classList.remove("icon-menu--title"))
              : t &&
                (((e = 500) => {
